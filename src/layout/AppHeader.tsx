    ...
    <header className="sticky top-0 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div
          ...
          } shadow-theme-md lg:shadow-none lg:flex w-full items-center justify-between gap-4 px-5 py-4 lg:justify-end lg:px-0`}
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            <ThemeToggleButton />
          </div>

          {/* User Dropdown → สำคัญ: ส่ง session เข้าไป */}
